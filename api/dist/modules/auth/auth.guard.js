...
let AuthGuard = class AuthGuard {
    ...
    async canActivate(context) {
        ...
        const isResetPassword = this.reflector.getAllAndOverride(IsResetPassword_1.IS_RESET_PASSWORD, [
            context.getClass(),
            context.getHandler(),
        ]);
        if (isPublic)
        ...
        try {
            const payload = await this.jwtService.verifyAsync(token, {
                secret: isResetPassword ? env_1.env.resetPasswordJwtSecret : env_1.env.jwtSecret,
            });
